...
/*
 Func: write between server and client
 Param: file descriptor, buffer to pass content and length of content being passes
...
/*
 Func: read between server and client
 Param: file descriptor, buffer to pass content and length of content being passes
